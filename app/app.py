...
# === Config ===
INDEX_PATH = r"C:\Maximos\data\index\maximos_index.faiss"
METADATA_PATH = r"C:\Maximos\data\index\metadata.json"
...
def get_chunk_text(meta):
    chunk_file = os.path.join(r"C:\Maximos\data\chunks", meta["filename"])
